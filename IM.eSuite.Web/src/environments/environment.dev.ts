...
export const environment = {
  production: true,
  eSuiteApi : {
    endpoint : "http://api-esuite-dev.im.saint-gobain.com"
  },
  eSmatApi : {
    endpoint : "http://api-esmat-dev.im.saint-gobain.com"
  },
  eRiskApi : {
    endpoint : "http://api-erisk-dev.im.saint-gobain.com"
  },
  eActionApi : {
    endpoint : "https://lan-test-im.api.saint-gobain.com/eAction",
    keyId:{
  ...
  oAuth:{
    ...
    responseType: "code",
    clientId: "IM_eSuite_DEV",
    redirectUri: "http://esuite-dev.im.saint-gobain.com/signin-websso",
